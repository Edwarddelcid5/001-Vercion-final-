                            ...
                            <div class="collapse navbar-collapse sub-menu-bar" id="navbarSupportedContent">
                                <ul id="nav" class="navbar-nav ml-auto">
                                    <li class="nav-item active">
                                        <a class="page-scroll" href="#home"><i class='bx bx-home-alt'></i>Inicio</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="page-scroll" href="#features"><i class='bx bxs-food-menu'></i> Menu </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="page-scroll" href="#about"><i class='bx bx-error' ></i>Acerca de</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="page-scroll" href="./publicaciones/Index.php">Publicaciones</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="page-scroll" href="#team">Correo</a>
                                    </li>
                                    <li class="nav-item">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-4 col-md-7 col-sm-8">
                    <div class="single-services text-center mt-30 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.2s">
                        ...
                        <div class="services-content mt-30">
                            <h4 class="services-title"><a href="#">Cuidados</a></h4>
                            <p class="text">Es muy importante para mantener a nuestro a animales de compañía que ingieran una dieta equilibrada que satisfaga sus necesidades energéticas y proporcione los nutrientes adecuados..</p>
                            <a class="more" href="#">Ver mas <i class="lni-chevron-right"></i></a>
                        </div>
                    </div> <!-- single services -->
                </div>
                <div class="col-lg-4 col-md-7 col-sm-8">
                    <div class="single-services text-center mt-30 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.5s">
                        ...
                        <div class="services-content mt-30">
                            <h4 class="services-title"><a href="#">Enfermedades</a></h4>
                ...
                <div class="col-lg-4 col-md-7 col-sm-8">
                    <div class="single-services text-center mt-30 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.8s">
                        ...
                        <div class="services-content mt-30">
                            <h4 class="services-title"><a href="#">Medicamentos</a></h4>
                            <p class="text">Lorem ipsum dolor sit amet,consetetur sadipscing elitr, seddiam nonu eirmod tempor invidunt labore.</p>
                            <a class="more" href="#">Learn More <i class="lni-chevron-right"></i></a>
                        </div>
                    </div> <!-- single services -->
                ...
                <div class="col-lg-6">
                    <div class="about-content mt-50 wow fadeInLeftBig" data-wow-duration="1s" data-wow-delay="0.5s">
                        <div class="section-title">
                            <div class="line"></div>
                            <h3 class="title">Sabias que  <span>Parte de lo que lleva la pagina</span></h3>
                        </div> <!-- section title -->
            ...
            <div class="row">
                <div class="col-lg-6 order-lg-last">
                    <div class="about-content mt-50 wow fadeInLeftBig" data-wow-duration="1s" data-wow-delay="0.5s">
                        <div class="section-title">
                            <div class="line"></div>
                            <h3 class="title">Un estilo moderno <span> Pagina mas minimaslista y rapoida</span></h3>
                        </div> <!-- section title -->
                        <p class="text">Lorem ipsum dolor sit amet, consetetur sadipscing elitr, seiam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet. Lorem ipsum dolor sit amet, consetetur sadipscing.</p>
                        <a href="#" class="main-btn">Try it Free</a>
                    </div> <!-- about content -->
                    ...
                    <div class="video-content mt-50 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.5s">
                        ...
                        <div class="video-wrapper">
                            ...
                            <div class="video-icon">
                                <a href="https://www.youtube.com/watch?v=sNCWJh-WNH8" class="video-popup"><i class="lni-play"></i></a>
                            </div>
                        </div> <!-- video wrapper -->
                    </div> <!-- video content -->
                </div>
                <div class="col-lg-6">
                    <div class="counter-wrapper mt-50 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.8s">
                        <div class="counter-content">
                            <div class="section-title">
                                <div class="line"></div>
                                <h3 class="title"> Mira el video<span>Refeclicon </span></h3>
                            </div> <!-- section title -->
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-5">
                    <div class="section-title text-center pb-40">
                        <div class="line m-auto"></div>
                        <h3 class="title">Personas que han ayudado al desarollo<span> </span></h3>
                    </div> <!-- section title -->
                </div>
            </div> <!-- row -->
